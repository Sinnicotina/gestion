                                    ...
                                    <form action="{{ route('tickets.update', $ticket->id) }}" method="POST"
                                        ...
                                        <select name="estado" onchange="this.form.submit()">
                                            <option value="Backlog"
                                                {{ $ticket->estado == 'Backlog' ? 'selected' : '' }}>Backlog</option>
                                            <option value="En Progreso"
                                                {{ $ticket->estado == 'En Progreso' ? 'selected' : '' }}>En Progreso
                                            </option>
                                            <option value="En Revisión"
                                                {{ $ticket->estado == 'En Revisión' ? 'selected' : '' }}>En Revisión
                                            </option>
                                            <option value="Resuelto"
                                                {{ $ticket->estado == 'Resuelto' ? 'selected' : '' }}>Resuelto</option>
                                            <option value="Cerrado"
                                                {{ $ticket->estado == 'Cerrado' ? 'selected' : '' }}>Cerrado</option>
                                        </select>
                                    </form>
                                </li>
                            @endforeach
